...
<div class="content">
    ...
    <div class="main-content">
        ...
        <table class="table" border="1">
            <tr>
                <td style="text-align: center;width: 10em;">编号</td>
                <td>${leaveRecord.id}</td>
                <td style="text-align: center;width: 10em;">用户ID</td>
                <td>${leaveRecord.userId}</td>
            </tr>
            <tr>
                <td style="text-align: center;width: 10em;">请假开始时间</td>
                <td>${leaveRecord.startTime.toLocaleString()}</td>
                <td style="text-align: center;width: 10em;">请假结束时间</td>
                <td>${leaveRecord.endTime.toLocaleString()}</td>
            </tr>

            <tr>
                <td style="text-align: center;width: 10em;">审核状态</td>
                <td>${leaveRecord.auditStatus}</td>
            </tr>
            <tr>
                <td style="text-align: center;width: 10em;">请假类型</td>
                <td>${leaveRecord.type}</td>
            </tr>
            <tr>
                <td style="text-align: center;width: 10em;">详细原因</td>
